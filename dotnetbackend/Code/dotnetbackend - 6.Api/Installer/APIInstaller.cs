...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 6.Api.Filters;
using dotnetbackend - 6.Business.Installer;

namespace dotnetbackend - 6.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 6 API", Version = version + "-" + branch});
            });
