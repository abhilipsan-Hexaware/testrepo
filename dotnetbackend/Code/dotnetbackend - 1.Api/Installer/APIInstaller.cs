...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 1.Api.Filters;
using dotnetbackend - 1.Business.Installer;

namespace dotnetbackend - 1.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 1 API", Version = version + "-" + branch});
            });
