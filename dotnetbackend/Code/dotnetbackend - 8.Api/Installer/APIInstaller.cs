...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 8.Api.Filters;
using dotnetbackend - 8.Business.Installer;

namespace dotnetbackend - 8.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 8 API", Version = version + "-" + branch});
            });
