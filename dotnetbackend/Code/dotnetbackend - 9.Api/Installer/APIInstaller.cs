...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 9.Api.Filters;
using dotnetbackend - 9.Business.Installer;

namespace dotnetbackend - 9.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 9 API", Version = version + "-" + branch});
            });
