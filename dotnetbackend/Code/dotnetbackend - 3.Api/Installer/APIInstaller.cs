...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 3.Api.Filters;
using dotnetbackend - 3.Business.Installer;

namespace dotnetbackend - 3.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 3 API", Version = version + "-" + branch});
            });
