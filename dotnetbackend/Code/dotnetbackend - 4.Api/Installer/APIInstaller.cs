...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 4.Api.Filters;
using dotnetbackend - 4.Business.Installer;

namespace dotnetbackend - 4.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 4 API", Version = version + "-" + branch});
            });
