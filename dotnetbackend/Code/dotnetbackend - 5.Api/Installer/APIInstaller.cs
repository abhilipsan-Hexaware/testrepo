...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 5.Api.Filters;
using dotnetbackend - 5.Business.Installer;

namespace dotnetbackend - 5.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 5 API", Version = version + "-" + branch});
            });
