...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend.Api.Filters;
using dotnetbackend.Business.Installer;

namespace dotnetbackend.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend API", Version = version + "-" + branch});
            });
