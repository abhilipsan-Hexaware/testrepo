...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 7.Api.Filters;
using dotnetbackend - 7.Business.Installer;

namespace dotnetbackend - 7.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 7 API", Version = version + "-" + branch});
            });
