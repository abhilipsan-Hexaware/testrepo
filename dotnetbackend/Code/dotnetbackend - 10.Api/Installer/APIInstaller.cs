...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetbackend - 10.Api.Filters;
using dotnetbackend - 10.Business.Installer;

namespace dotnetbackend - 10.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetbackend - 10 API", Version = version + "-" + branch});
            });
